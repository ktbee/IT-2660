public class Main {
  public static void main(String[] args) {
    ...
    long bestElapsedTime = endTime - startTime;

    System.err.println("Best case elapsed time: " + bestElapsedTime + " nanoseconds");
    ...
    // * Calculate elapsedTime here
    long worstElapsedTime = endTime - startTime;

    System.err.println("Worst case elapsed time: " + worstElapsedTime + " nanoseconds");
